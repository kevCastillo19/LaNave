...
<section class="page-section bg-light my-5 py-5 pb-3 row justify-content-center" id="contact">
    <h3 class="text-center mx-5 float-left" style="font-family: 'Ethnocentric', arial; color:#FE0640;">Beat's Store!</h3>
  <form action="Buscar_Beat.php" class="form float-right" method="post"> 
    <div class="input-group ml-3 mb-3 w-100">
  ...
  <div class="input-group-append">
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <table class="table table-responsive my-3 pl-5 w-100 text-center" id='nodesc' >
          ...
          try{
            ...
            $con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                ...
                FROM `beats` 
                  ...
                  INNER JOIN `estado` ON `beats`.`id_estado` = `estado`.`id_estado`  ORDER BY `id_beat` DESC";
                  $res = $con->prepare($sql);
                  $res->execute();
